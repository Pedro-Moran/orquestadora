...
public class ConfigurationFactoryMock implements ApplicationConfigurationServiceFactory {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.bbva.elara.configuration.manager.application.factory. ApplicationConfigurationServiceFactory
	...
	public ApplicationConfigurationService getApplicationConfigurationService(BundleContext arg0) {
		...
		InputStream is = this.getClass().getResourceAsStream("/properties-test.properties");
		...
		ApplicationConfigurationService connectorConfigBundle = new ApplicationConfigurationService() {
			...
			@Override
			public String getDefaultProperty(String property, String defaultProperty) {
