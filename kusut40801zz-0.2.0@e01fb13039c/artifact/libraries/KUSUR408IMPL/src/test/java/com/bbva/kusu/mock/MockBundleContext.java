...
public class MockBundleContext implements BundleContext, ApplicationContextAware {
	...
	public Bundle getBundle() {
		...
		Mockito.when(mockBundle.getSymbolicName()).thenReturn("KUSUR408IMPL-0.0.1");
	...
	public ServiceReference<?>[] getAllServiceReferences(String clazz, String filter) throws InvalidSyntaxException {
		...
		serviceReferences = new ServiceReference<?>[1];
		serviceReferences[0] = getServiceReference(clazz);
		return serviceReferences;
	}
	...
	@Override
	public <S> ServiceRegistration<S> registerService(Class<S> registerClass, ServiceFactory<S> serviceFactory, Dictionary<String, ?> dictionary) {
		throw new UnsupportedOperationException("Operation not supported");
	}
