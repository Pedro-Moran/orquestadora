...
public class AliasFavContMgmtEntity extends AliasFavCommons implements Serializable {
	...
	public String toString() {
		return "AliasFavContMgmtEntity [gRecordUpdateType=" + gRecordUpdateType + ", toString()=" + super.toString()
				+ "]";
	}
