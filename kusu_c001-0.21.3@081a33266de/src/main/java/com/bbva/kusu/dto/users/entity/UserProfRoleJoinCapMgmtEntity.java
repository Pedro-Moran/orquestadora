...
public class UserProfRoleJoinCapMgmtEntity extends UserProfRoleCommons implements Serializable {
	...
	public String toString() {
		return "UserProfRoleJoinCapMgmtEntity [gRecordUpdateType=" + gRecordUpdateType + ", toString()=" + super.toString() + "]";
	}
