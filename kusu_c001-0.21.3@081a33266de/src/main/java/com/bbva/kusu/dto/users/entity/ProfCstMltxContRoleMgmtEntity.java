...
public class ProfCstMltxContRoleMgmtEntity extends CustomContractRoleCommons implements Serializable {
	...
	public String toString() {
		return "ProfCstMltxContRoleMgmtEntity [gCustomerId=" + gCustomerId + ", gUserPermissionCtrctId=" + gUserPermissionCtrctId
