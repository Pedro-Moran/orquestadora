...
public class AliasFavextContMgmtEntity extends ExternalContractCommons implements Serializable {
	...
	public String toString() {
		return "AliasFavextContMgmtEntity [gRecordUpdateType=" + gRecordUpdateType + ", toString()=" + super.toString() + "]";
	}
