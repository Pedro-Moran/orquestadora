...
public class ProfcstMltxextContREntity extends ExternalContractCommons implements Serializable {
	...
	public String toString() {
		return "ProfcstMltxextContREntity [gCustomerId=" + gCustomerId + ", super.toString()=" + super.toString() + "]";
	}
