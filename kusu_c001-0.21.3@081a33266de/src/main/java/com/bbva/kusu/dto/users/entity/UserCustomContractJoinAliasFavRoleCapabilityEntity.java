...
public class UserCustomContractJoinAliasFavRoleCapabilityEntity extends UserCustomContractJoinAliasCommons implements Serializable {
	...
	public String toString() {
		return "UserCustomContractJoinAliasFavRoleCapabilityEntity [gUserPermissionCtrctId=" + gUserPermissionCtrctId + ", toString()="
				+ super.toString() + "]";
	}
